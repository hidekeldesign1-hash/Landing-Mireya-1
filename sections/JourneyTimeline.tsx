    ...
    <section className="border-y border-beige-dark/50 bg-beige py-14 sm:py-16">
      <Container>
        ...
        <MotionSection stagger className="relative mt-12">
          <div
            className="pointer-events-none absolute left-0 right-0 top-6 hidden h-px bg-forest/35 lg:block"
            aria-hidden
          />
              ...
              return (
                <MotionItem key={step.id}>
                  <li className="flex flex-col items-center text-center">
                    <span className="relative z-10 mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-forest/40 bg-white text-forest shadow-sm">
